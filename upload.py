...
CLIENT_SECRETS_FILE = \
    '/content/drive/My Drive/key/client_secret_472764921288-jbenv3gs9hnbtcdtbrb7gs7h2ennf6cf.apps.googleusercontent.com.json'
...
def initialize_upload(youtube, options, MEDIA_FILE_PATH_GET):
    ...
    insert_request = \
        youtube.videos().insert(part=','.join(body.keys()), body=body,
                                media_body=MediaFileUpload(MEDIA_FILE_PATH_GET,
